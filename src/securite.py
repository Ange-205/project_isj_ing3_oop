...
gestion.ajouter_regle("admin", "0000", "bloquer", "192.168.1.2", "UDP", 443)

p1 = Paquet("192.168.1.1", "10.0.0.1", "TCP", 500, 2)
p2 = Paquet("192.168.1.2", "10.0.0.2", "UDP", 200, 1)
p3 = Paquet("192.168.1.5", "10.0.0.3", "ICMP", 100, 3)

gestion.inspecter_paquet(p1)
gestion.inspecter_paquet(p2)
gestion.inspecter_paquet(p3)
